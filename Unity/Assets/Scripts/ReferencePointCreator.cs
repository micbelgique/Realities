...
{
    public delegate void ObjectPlacedEventHandler(Transform transform);
    public event ObjectPlacedEventHandler OnObjectPlacement;
    ...
    void Update()
    {
        ...
        if (m_RaycastManager.Raycast(touch.position, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            //var gameObject = Instantiate(m_ReferencePointPrefab, referencePoint.transform);

            OnObjectPlacement?.Invoke(referencePoint.transform);
